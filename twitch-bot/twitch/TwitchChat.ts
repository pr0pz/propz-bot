...
export class TwitchChat
{
	...
	async sendMessage( message: string = '', replyTo?: ChatMessage )
	{
		...
		{
			if ( replyTo )
				await this.chatClient.say( this.twitch.data.userName, message, { replyTo: replyTo } );
			else
	 ...
	 * @param {UserNotice} _msg - The full message object containing all message and user information.
	 */
	onRaid = ( _channel: string, _user: string, raidInfo: ChatRaidInfo, msg: UserNotice ) =>
	{
	 ...
	 * @param {UserNotice} _msg - The full message object containing all message and user information.
	 */
	onResub = ( _channel: string, _user: string, subInfo: ChatSubInfo, msg: UserNotice ) =>
	{
